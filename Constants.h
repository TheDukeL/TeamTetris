...
const int ONELEVELSPEED = 50; //how much the speed increments per level
const int INITALSPEED = 600; //how fast the tetrominoes fall at game start
...
const int STARTINGX = 4, STARTINGY = 0; //the position on the grid where new tetrominos spawn
